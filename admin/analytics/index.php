...
// Подтверждённые продажи собственной воронки «Курсы», не попавшие в orders.
// ЦДО не включаем: C4:WON подтверждает заключение сделки, но не оплату.
// Материализованные заказы уже учтены выше и здесь исключаются от задвоения.
$offlineCrm = null;
    ...
    <div class="utm-table-wrapper">
        <table class="utm-table" id="utmTable">
            ...
            <tbody>
                ...
                <?php if ($offlineCrm): ?>
                <!-- Подтверждённые продажи собственной воронки курсов вне заказов -->
                <tr class="utm-row utm-row-no-expand" title="Подтверждённые продажи воронки «Курсы», которых нет в заказах сайта. ЦДО без подтверждения оплаты из 1С не учитывается.">
                    <td class="col-label">
