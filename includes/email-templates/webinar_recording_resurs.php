<?php
/**
 * Email Template: Запись вебинара «Как сохранить ресурс»
...
<div class="email-content">
    ...
    <p>5 марта состоялся вебинар «<?php echo htmlspecialchars($webinar_title); ?>». Запись уже доступна — смотрите в любое удобное время!</p>
