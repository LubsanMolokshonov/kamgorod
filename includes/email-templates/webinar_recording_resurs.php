<?php
/**
 * Email Template: Запись вебинара «Как сохранить ресурс…» (минимальный HTML)
 */

$email_subject = "Запись вебинара «Как сохранить ресурс и не потерять качество работы» — смотрите бесплатно";
$utm = 'utm_source=email&utm_campaign=recording_resurs';
...
<p>5 марта состоялся вебинар <strong>«<?= htmlspecialchars($webinar_title) ?>»</strong>. Запись уже доступна — смотрите в любое удобное время.</p>
...
— <a href="<?= htmlspecialchars($pres_link) ?>">скачать презентацию и материалы от эксперта</a><br>
