<?php
/**
 * Email Template: Запись вебинара «Критериальное оценивание. 7 инструментов для каждого урока»
 * Рассылка зарегистрированным участникам: запись + презентация + анкета ОС + сертификат.
 * Структура — копия webinar_recording_osobyj_rebenok.php.
 */

// Subject и UTM можно переопределить из вызывающего скрипта.
$email_subject = $email_subject ?? 'Запись вебинара «Критериальное оценивание» + презентация и подарок';
$utm           = $utm           ?? 'utm_source=email&utm_campaign=recording_kriterialnoe';
...
<div class="email-content">
    ...
    <p>21 мая состоялся вебинар «<?php echo htmlspecialchars($webinar_title); ?>». Запись уже доступна — смотрите в любое удобное время!</p>
    ...
    <div style="background: linear-gradient(135deg, #ecefff 0%, #f8fafc 100%); border-radius: 16px; padding: 25px; margin: 25px 0; border-left: 4px solid #1e3aa8;">
        ...
        <p style="color: #4A5568; margin: 10px 0;">
            ...
            <a href="<?php echo htmlspecialchars($presentation_url); ?>?<?php echo $utm; ?>" style="color: #1e3aa8; text-decoration: none; font-weight: 500;">Скачать презентацию эксперта</a>
        </p>
        <p style="color: #4A5568; margin: 10px 0;">
            <span style="margin-right: 8px;">📝</span>
            ...
            <span style="color: #16a34a; font-weight: 600;"> — в конце вас ждёт подарок 🎁</span>
        </p>
    </div>
