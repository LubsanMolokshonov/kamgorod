<?php
/**
 * Email Template: Запись вебинара «Наставник 2026» (минимальный HTML)
 */

$email_subject = "Запись вебинара «Наставник 2026» — смотрите бесплатно";
$utm = 'utm_source=email&utm_campaign=recording_nastavnik';
...
<p>19 марта состоялся вебинар <strong>«<?= htmlspecialchars($webinar_title) ?>»</strong>. Запись уже доступна — смотрите в любое удобное время.</p>
...
— <a href="<?= htmlspecialchars($pres_link) ?>">скачать презентацию и подарки от эксперта</a><br>
