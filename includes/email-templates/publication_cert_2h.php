...
<div class="email-content">
    ...
    <?php
    // Блок «поделитесь» — мотивируем автора рассказать о публикации ВКонтакте.
    // Ссылка размечена UTM (кампания publication_share, utm_content=email) —
    // переходы по расшаренным ссылкам видны в отчёте /admin/publication-shares/.
    $share_url_vk = $publication_url
        . (strpos($publication_url, '?') !== false ? '&' : '?')
        . 'utm_source=vk&utm_medium=social&utm_campaign=publication_share&utm_content=email';
    ...
    <div style="background: #f0f9ff; border: 1px solid #bae6fd; border-radius: 14px; padding: 22px; margin: 24px 0; text-align: center;">
        ...
        <p style="margin: 0 0 16px; color: #475569; font-size: 14px;">Поделитесь ссылкой ВКонтакте — о вашей работе узнают коллеги, а у статьи станет больше читателей.</p>
        <a href="https://vk.com/share.php?url=<?php echo urlencode($share_url_vk); ?>&title=<?php echo $share_enc_title; ?>" style="display: inline-block; padding: 12px 28px; background: #07f; color: #ffffff; text-decoration: none; border-radius: 8px; font-size: 14px; font-weight: 600;">Поделиться ВКонтакте</a>
    </div>
