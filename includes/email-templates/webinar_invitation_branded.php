<?php
/**
 * Брендированное приглашение на бесплатный вебинар (массовая рассылка по базе users).
 * Использует _webinar_base_layout.php — общий «красивый» шаблон ФГОС-Практикум.
 *
...
// $webinar_link приходит из вызывающего скрипта — это либо magic-link `/m/{token}/{base64(target)}`
// (пользователь авторизуется и попадает на страницу вебинара), либо обычный URL для теста.
$webinar_link = $webinar_link ?? ($site_url . '/vebinar/' . $webinar_slug . '/');

$email_subject = 'Вебинар про особых детей — ' . ($webinar_date ?? '13 мая');
...
<div class="email-header">
    <div class="email-header-content">
        ...
        <p>Для воспитателей, специалистов и родителей</p>
    </div>
</div>
...
<div class="email-content">
    ...
    <p>Тема непростая, но обойти её сегодня сложно: в каждой группе ДОУ или классе встречается ребёнок, которому нужен особый подход. Мы собрали практический разбор — без воды и научного занудства.</p>
    ...
    <ul style="color:#2a3056; padding-left: 20px; margin: 18px 0;">
        <li style="margin-bottom: 8px;">10 простых шагов поддержки в условиях обычной группы — без отдельных программ.</li>
        <li style="margin-bottom: 8px;">Что делать в первый день, когда такой ребёнок только пришёл.</li>
        <li style="margin-bottom: 8px;">Как мягко выстроить разговор с родителями — и своими, и группы.</li>
        <li style="margin-bottom: 8px;">Какие приёмы работают в реальном расписании, а какие красиво звучат, но не приживаются.</li>
    </ul>
