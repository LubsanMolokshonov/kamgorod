<?php
/**
 * Email Template: Запись вебинара «Разговоры о важном» (минимальный HTML)
 */

$email_subject = "Запись вебинара «Разговоры о важном» — смотрите бесплатно";
$utm = 'utm_source=email&utm_campaign=recording_broadcast';
...
<p>12 февраля состоялся вебинар <strong>«<?= htmlspecialchars($webinar_title) ?>»</strong>. Запись уже доступна — смотрите в любое удобное время.</p>
...
Документ с уникальным номером и QR-кодом для портфолио.<br>
