<?php
/**
 * Email Template: Запись вебинара «Читательские марафоны» (минимальный HTML)
 */

$email_subject = "Запись вебинара «Читательские марафоны» — смотрите бесплатно";
$utm = 'utm_source=email&utm_campaign=recording_chitatelskie';
...
<p>25 февраля состоялся вебинар <strong>«<?= htmlspecialchars($webinar_title) ?>»</strong>. Запись уже доступна — смотрите в любое удобное время.</p>
