<?php
/**
 * Email Template: Запись вебинара «Нейросети для педагога»
 * Рассылка зарегистрированным участникам: запись + презентация + анкета + сертификат + следующий вебинар
 */

$email_subject = "Запись вебинара «Нейросети для педагога» — смотрите бесплатно!";

$utm = 'utm_source=email&utm_campaign=recording_nejroseti';
...
<div class="email-content">
    ...
    <p>7 апреля состоялся вебинар «<?php echo htmlspecialchars($webinar_title); ?>». Запись уже доступна — смотрите в любое удобное время!</p>
    ...
    <div style="background: linear-gradient(135deg, #E8F1FF 0%, #f8fafc 100%); border-radius: 16px; padding: 25px; margin: 25px 0; border-left: 4px solid #0077FF;">
        ...
        <p style="color: #4A5568; margin: 10px 0;">
            ...
            <a href="<?php echo htmlspecialchars($presentation_url); ?>?<?php echo $utm; ?>" style="color: #0077FF; text-decoration: none; font-weight: 500;">Скачать презентацию (в неё вшиты полезные материалы)</a>
        </p>
        <p style="color: #4A5568; margin: 10px 0;">
            <span style="margin-right: 8px;">📝</span>
    ...
    <div style="background: linear-gradient(135deg, #faf5ff 0%, #f3e8ff 100%); border-radius: 16px; padding: 25px; margin: 30px 0; text-align: center; border-left: 4px solid #8b5cf6;">
        ...
        <p style="color: #718096; margin-bottom: 20px; font-size: 14px;">23 апреля в 14:00 по Москве<br>Продолжите повышение квалификации вместе с нами!</p>
