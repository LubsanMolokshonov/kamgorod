<?php
/**
 * Email Template: Запись вебинара «Нейросети для педагога» (минимальный HTML)
 */
...
<p>7 апреля состоялся вебинар <strong>«<?= htmlspecialchars($webinar_title) ?>»</strong>. Запись уже доступна — смотрите в любое удобное время.</p>
...
— <a href="<?= htmlspecialchars($pres_link) ?>">скачать презентацию (в неё вшиты полезные материалы)</a><br>
