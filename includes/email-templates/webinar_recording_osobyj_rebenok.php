<?php
/**
 * Email Template: Запись вебинара «Особый ребёнок: 10 шагов»
 * Рассылка зарегистрированным участникам: запись + презентация + анкета + сертификат
 */

// Subject и UTM можно переопределить из вызывающего скрипта (например, для cold-аудитории).
$email_subject = $email_subject ?? "Запись вебинара «Особый ребёнок: 10 шагов» — смотрите бесплатно";
$utm           = $utm           ?? 'utm_source=email&utm_campaign=recording_osobyj_rebenok';
...
<div class="email-content">
    ...
    <p>13 мая состоялся вебинар «<?php echo htmlspecialchars($webinar_title); ?>». Запись уже доступна — смотрите в любое удобное время!</p>
