<?php
// Настраиваемые параметры (задать перед include этого файла)
...
<div class="catalog-search" id="catalogSearch" data-context="<?php echo htmlspecialchars($catalogSearchContext); ?>" data-endpoint="<?php echo htmlspecialchars($catalogSearchEndpoint); ?>">
    <div class="catalog-search-container">
        ...
        <input type="text"
               ...
               placeholder="<?php echo htmlspecialchars($catalogSearchPlaceholder); ?>"
               autocomplete="off"
               aria-label="<?php echo htmlspecialchars($catalogSearchAriaLabel); ?>">
