...
// H1Pro - скрипт автозамены заголовков (АБ-тест)
$earlyHeadScripts = ['<script src="https://new.h1pro.ru/sdk/h1pro.js" data-api-key="h1p_w_T5uh2TCSgtmp_5QrwvyzxzNYH5fZEcWlI88nKBpqE"></script>']; 
