...
<section class="rd-section">
  <div class="rd-wrap">
    ...
    <div class="rd-faq-list reveal-stagger" style="max-width:880px;margin:0 auto;">
      <?php
      $faqItems = [
        ['Как быстро я получу диплом?', 'Диплом формируется автоматически сразу после подтверждения оплаты. Обычно это занимает не более 5 минут. Вы сможете скачать диплом в личном кабинете в формате PDF.'],
        ['Как можно оплатить?', 'Мы принимаем оплату через ЮKassa: банковские карты (Visa, MasterCard, МИР), электронные кошельки (ЮMoney, QIWI), СБП. Все платежи защищены и проходят через безопасное соединение.'],
        ['Можно ли изменить данные в дипломе?', 'Да, вы можете обратиться в службу поддержки для корректировки данных в дипломе. Мы бесплатно исправим любые ошибки и вышлем обновлённый диплом.'],
        ['Действует ли скидка на несколько конкурсов?', 'Да! При оплате двух конкурсов третий конкурс вы получаете бесплатно. Добавьте конкурсы в корзину и оплатите все сразу — скидка применяется автоматически.'],
        ['Нужна ли регистрация на сайте?', 'Регистрация происходит автоматически при оформлении участия в конкурсе. Вы получите доступ в личный кабинет, где сможете управлять дипломами.'],
        ['Сколько хранятся дипломы на сайте?', 'Дипломы хранятся в вашем личном кабинете бессрочно. Вы можете скачать их в любой момент.'],
        ['Вы выдаёте официальные дипломы?', 'Да, все наши дипломы являются официальными документами. Мы работаем на основании свидетельства о регистрации СМИ: Эл. №ФС 77-74524.'],
        ['Можно ли выбрать дизайн диплома?', 'Да, при оформлении участия вы можете выбрать один из предложенных шаблонов дизайна диплома.'],
      ];
