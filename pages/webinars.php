...
$faqItems = [
    ...
    ['q' => 'Как получить сертификат?', 'a' => 'После просмотра пройдите короткий тест из 5 вопросов. Затем оформите именной сертификат на 2 ак. часа — он сразу появится в личном кабинете.'],
    ['q' => 'Принимается ли сертификат при аттестации?', 'a' => 'Сертификаты выдаются от имени зарегистрированного СМИ (Эл. №ФС 77-74524) и принимаются в портфолио. Для аттестации лучше сочетать с курсами повышения квалификации в ФИС ФРДО.'],
];
    ...
    <div class="rd-hero-art rd-hero-art-cat reveal">
      ...
      <div class="hero-diploma" style="position:absolute;inset:0;padding:0;">
        <div class="diploma-stack">
          <div class="diploma-item diploma-1"><img src="/assets/images/diplomas/previews/diploma-1.svg" alt="Сертификат вариант 1" loading="lazy" decoding="async"></div>
          <div class="diploma-item diploma-2"><img src="/assets/images/diplomas/previews/diploma-2.svg" alt="Сертификат вариант 2" loading="lazy" decoding="async"></div>
          <div class="diploma-item diploma-3"><img src="/assets/images/diplomas/previews/diploma-3.svg" alt="Сертификат вариант 3" loading="lazy" decoding="async"></div>
          <div class="diploma-item diploma-4"><img src="/assets/images/diplomas/previews/diploma-4.svg" alt="Сертификат вариант 4" loading="lazy" decoding="async"></div>
          <div class="diploma-item diploma-5"><img src="/assets/images/diplomas/previews/diploma-5.svg" alt="Сертификат вариант 5" loading="lazy" decoding="async"></div>
          <div class="diploma-item diploma-6"><img src="/assets/images/diplomas/previews/diploma-6.svg" alt="Сертификат вариант 6" loading="lazy" decoding="async"></div>
        </div>
      </div>
