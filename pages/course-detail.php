...
$faqItems = [
    ...
    ['q' => 'Как проходит обучение?', 'a' => 'Обучение проходит полностью дистанционно. После оплаты вы получаете доступ к учебным материалам и можете проходить их в удобном темпе.'],
