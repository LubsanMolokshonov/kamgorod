...
$faqItems = [
    ['q' => 'Какой документ я получу?', 'a' => $credentialType . ' установленного образца. Данные вносятся в ФИС ФРДО (Федеральный реестр). Документ принимается при аттестации и любой проверке.'],
    ['q' => 'Как проходит обучение?', 'a' => 'Обучение проходит полностью дистанционно. После оплаты с вами связывается методист и открывает доступ к учебным материалам — дальше вы изучаете их в удобном темпе, без отрыва от работы.'],
