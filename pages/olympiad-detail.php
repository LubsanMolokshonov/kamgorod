  ...
  <div class="rd-wrap">
    ...
    <div class="rd-steps four reveal-stagger">
      ...
      <div class="rd-step">
        ...
        <h4>Диплом</h4>
        <p>Оформите именной диплом за <?php echo $diplomaPrice; ?>&nbsp;₽.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="rd-section tight">
  <div class="rd-wrap">
    <div class="cd-price-band reveal">
      ...
      <div class="note">Диплом за <?php echo $diplomaPrice; ?>&nbsp;₽ — оформляется по желанию после прохождения теста</div>
      <a href="<?php echo $testUrl; ?>" class="rd-btn rd-btn-primary">
        Пройти олимпиаду
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14m-6-6 6 6-6 6"/></svg>
      </a>
...
<section class="rd-section">
  <div class="rd-wrap">
    ...
    <div class="rd-faq-list reveal-stagger" style="max-width:880px;margin:0 auto;">
      <?php
      $faqItems = [
        ['Как проходит олимпиада?', 'Олимпиада проходит в онлайн-формате. После регистрации вам будет предложено ответить на 10 вопросов по теме. Время прохождения не ограничено. Вы увидите свой результат сразу после завершения теста.'],
        ['Участие действительно бесплатное?', 'Да, участие в олимпиаде полностью бесплатное. Оплата требуется только в том случае, если вы захотите получить именной диплом. Стоимость оформления диплома составляет ' . $diplomaPrice . ' руб.'],
        ['Какие вопросы в олимпиаде?', 'Олимпиада содержит 10 вопросов в формате теста с вариантами ответов. Вопросы составлены профессиональными методистами и соответствуют тематике олимпиады.'],
        ['Как определяется место участника?', 'Место определяется по количеству правильных ответов: 9–10 правильных — 1 место, 8 — 2 место, 7 — 3 место. При результате менее 7 — статус участника.'],
        ['Можно ли пройти олимпиаду повторно?', 'Да, вы можете пройти олимпиаду повторно для улучшения результата. Каждая попытка генерирует новый набор вопросов. При оформлении диплома используется лучший из результатов.'],
        ['Какие документы подтверждают легитимность?', 'Портал работает на основании лицензии на образовательную деятельность № Л035-01212-59/00203856 и свидетельства о регистрации СМИ Эл. №ФС 77-74524. Также мы — резидент «Сколково». Все дипломы являются официальными документами.'],
      ];
