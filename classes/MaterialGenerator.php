...
2. СООТВЕТСТВИЕ ТЕМЫ КЛАССУ: тема и глубина содержания должны точно соответствовать программе заявленного класса/ступени {$stage} по {$program}. Проверь по реальной программе РФ: если тема/приём относится к другому классу (напр. формула пути S=v·t и задачи на движение — это 4 класс, а не 3; полный письменный алгоритм умножения многозначного — 4 класс; в 5 классе по прилагательному обязательны разряды, склонение, согласование, краткие формы, НЕ с прилагательными, суффиксы — а не уровень «найди прилагательное») — приведи содержание к корректному для этого класса уровню и наполни обязательными для класса элементами программы.
