...
class YmlFeedGenerator
{
    ...
    private function buildOlympiadAdOffers(): string
    {
        ...
        foreach ($olympiads as $oly) {
            ...
            $params = [
                ['name' => 'Тип', 'value' => 'Олимпиада'],
                ['name' => 'Уровень', 'value' => 'Всероссийский'],
                ['name' => 'Предмет', 'value' => $subject],
                ['name' => 'Аудитория', 'value' => mb_strtoupper(mb_substr($audienceLabel, 0, 1)) . mb_substr($audienceLabel, 1)],
                ['name' => 'Документ', 'value' => 'Диплом'],
                ['name' => 'Формат', 'value' => 'Дистанционный'],
            ];
    ...
    // Маппинг предмета олимпиады → ярлык аудитории для заголовка
    private const OLYMPIAD_SUBJECT_AUDIENCE_MAP = [
        // Логопедия
        'Автоматизация звуков'                       => 'логопедов',
        'Диагностика письменной речи'                => 'логопедов',
        'Диагностика речевого развития'              => 'логопедов',
        'Дифференциация звуков'                      => 'логопедов',
        'Обследование звукопроизношения'             => 'логопедов',
        'Общее недоразвитие речи'                    => 'логопедов',
        'Постановка звуков'                          => 'логопедов',
        'Развитие связной речи при ОНР'              => 'логопедов',
        'Формирование лексико-грамматического строя'  => 'логопедов',
        // Дефектология
        'Дефектология'                               => 'дефектологов',
        // Психология
        'Педагог-психолог'                           => 'психологов',
        'Специальная психология'                     => 'психологов',
        // Коррекционная / инклюзия
        'Коррекционная педагогика'                   => 'педагогов ОВЗ',
        'Инклюзивное образование'                    => 'педагогов ОВЗ',
        // Соц. педагогика
        'Социальная педагогика'                      => 'соц. педагогов',
        // Классное руководство / воспитательная работа
        'Классное руководство'                       => 'кл. руководителей',
        'Воспитательная работа'                      => 'кл. руководителей',
        // Администрация
        'Администрация и управление'                 => 'руководителей ОО',
        // Методист
        'Методист'                                   => 'методистов',
        ...
        // ДОУ — воспитатели
        'ФГОС ДО'                                    => 'воспитателей ДОУ',
        'Развивающая предметно-пространственная среда' => 'воспитателей ДОУ',
        'Игровая деятельность'                       => 'воспитателей ДОУ',
        'Развитие речи'                              => 'воспитателей ДОУ',
        'Математика и логика'                        => 'воспитателей ДОУ',
        'Художественное творчество'                  => 'воспитателей ДОУ',
        'Экологическое воспитание'                   => 'воспитателей ДОУ',
        'Социально-коммуникативное развитие'         => 'воспитателей ДОУ',
        'Физическое развитие'                        => 'воспитателей ДОУ',
        // ДОУ — музыка
        'Музыка и танцы'                             => 'муз. руководителей',
        // Школьные предметы
        'Русский язык'                               => 'учителей рус. языка',
        'Русский язык и литература'                  => 'учителей рус. языка',
        'Литературное чтение'                        => 'учителей нач. классов',
        'Окружающий мир'                             => 'учителей нач. классов',
        'Математика'                                 => 'учителей математики',
        'Биология'                                   => 'учителей биологии',
        'География'                                  => 'учителей географии',
        'История'                                    => 'учителей истории',
        'Обществознание'                             => 'учителей обществознания',
        'Физика'                                     => 'учителей физики',
        'Химия'                                      => 'учителей химии',
        'Информатика и ИКТ'                          => 'учителей информатики',
        'Иностранные языки'                          => 'учителей ин. языков',
        'Английский язык'                            => 'учителей англ. языка',
        'Технология'                                 => 'учителей технологии',
        'Изобразительное искусство'                  => 'учителей ИЗО',
        'Музыка'                                     => 'учителей музыки',
        'Музыка и МХК'                               => 'учителей музыки',
        'ОБЖ'                                        => 'учителей ОБЖ',
        'Физическая культура'                        => 'учителей физкультуры',
        // Общепедагогические
        'Методика преподавания'                      => 'учителей',
        'Цифровые технологии в образовании'          => 'педагогов',
    ];
    ...
    /**
     * Построить рекламное описание для олимпиады — универсальное
     */
