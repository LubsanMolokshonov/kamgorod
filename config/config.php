...
// Одна релевантная рекомендация курса в MAX через N часов после оплаты.
// Рубильник намеренно отделён от общего CHATPUSH_ENABLED.
if (!defined('MAX_COURSE_RECOMMENDATION_ACTIVE')) define('MAX_COURSE_RECOMMENDATION_ACTIVE', filter_var($_ENV['MAX_COURSE_RECOMMENDATION_ENABLED'] ?? 'false', FILTER_VALIDATE_BOOLEAN));
if (!defined('MAX_COURSE_RECOMMENDATION_DELAY_HOURS')) define('MAX_COURSE_RECOMMENDATION_DELAY_HOURS', max(1, (int)($_ENV['MAX_COURSE_RECOMMENDATION_DELAY_HOURS'] ?? 24)));
if (!defined('MAX_COURSE_RECOMMENDATION_COOLDOWN_DAYS')) define('MAX_COURSE_RECOMMENDATION_COOLDOWN_DAYS', max(1, (int)($_ENV['MAX_COURSE_RECOMMENDATION_COOLDOWN_DAYS'] ?? 30)));
if (!defined('MAX_COURSE_RECOMMENDATION_BATCH')) define('MAX_COURSE_RECOMMENDATION_BATCH', max(1, min(100, (int)($_ENV['MAX_COURSE_RECOMMENDATION_BATCH'] ?? 25))));
if (!defined('MAX_COURSE_RECOMMENDATION_HOURLY_CAP')) define('MAX_COURSE_RECOMMENDATION_HOURLY_CAP', max(1, (int)($_ENV['MAX_COURSE_RECOMMENDATION_HOURLY_CAP'] ?? 30)));
